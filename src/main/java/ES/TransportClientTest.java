...
public class TransportClientTest {
    ...
    public void CreateIndexAndMapping() throws Exception{
        ...
        XContentBuilder mapping = XContentFactory.jsonBuilder()
                ...
                .startObject("author").field("type","string").field("type","string").field("analyzer","ik_smart").field("search_analyzer","ik_smart").endObject()   //内置
                .startObject("title").field("type","string").field("analyzer","ik_smart").field("search_analyzer","ik_smart").endObject()
                .startObject("content").field("type","string").field("analyzer","ik_smart").field("search_analyzer","ik_smart").endObject()
...
//	         .get();
    ...
    public void batchUndercarriageFamilies() {
        List<String> publishIds=new ArrayList<String>();
...
//        }
    ...
    public void searchByIndex(){
        ...
        GetResponse response = client.prepareGet(article,content,"AV49wyfCWmWw7AxKFxec").execute().actionGet();
    ...
    public void multiMatchQuery(){
        QueryBuilder queryBuilder = QueryBuilders.multiMatchQuery("书籍库","title", "content");
        SearchResponse response = client.prepareSearch(article).setQuery(queryBuilder).get();
        for (SearchHit  searchHit: response.getHits()) {
            println(searchHit);
        }
    ...
    public void MultiMatchQueryBuilder() throws Exception {
        ...
        MultiMatchQueryBuilder multiMatchQueryBuilder = QueryBuilders.multiMatchQuery("书籍库","title", "content");
    ...
    public void boostingQuery() throws Exception {
        QueryBuilder qb = QueryBuilders.boostingQuery(
                ...
                .negativeBoost(0.2f);//设置负增强因子。  //标准化因子 数据不太懂
        SearchResponse response=client.prepareSearch().setQuery(qb).execute().actionGet();
...
//      AggregationBuilders.reverseNested("res_negsted").path("kps ");
    ...
    public void MultiSearchResponse(){
        ...
        SearchRequestBuilder srb1 = client.prepareSearch().setQuery(QueryBuilders.queryStringQuery("fendo"));
    ...
    public void queryPageScroll(){
        ...
        QueryBuilder qb = QueryBuilders.termQuery("id", "101");
